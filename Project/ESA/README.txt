...
1. To Create a Corpus with wikipedia articles.
python Create_Corpus.py
The files get stored in the corpus folder.

2. To Create the word x article matrix using the corpus.
python Word_Article_Matrix.py
Which gets saved and used.
